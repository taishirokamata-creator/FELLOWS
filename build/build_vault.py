...
CHARS = {
 ...
 "脇脇脇男":{"gen":"親→子","aliases":["脇脇脇男","わっき","ワキヤス"],"kin":[],
   "desc":"親＝わっき〜。子＝脇脇脇男（勘が鋭い）。歴史改変（ゼンイセカイ）では“ワキヤスメ・アツコ”とも。"},
 ...
 "アウトオブウメコ":{"gen":"親→子／改名","aliases":["アウトオブウメコ","ウメコ","梅田","小梅"],"kin":[],
   "desc":"スイーツ人狼ルーム店長の子＝梅田。歴史改変でアウトオブウメコに。"},
 "クニタケチユキ":{"gen":"親→子","aliases":["クニタケ","ちゆっき"],"kin":[],
   "desc":"親＝ちゆっきー。子＝バンド THE FOREVER YOUNG（エバヤン）のボーカル。『FELLOWS』の名の由来に関わる。実在の元ネタはエバヤンのボーカル＆ベース、クニタケヒロキ。"},
 ...
 "ア・バイバイ":{"gen":"子／改名","aliases":["ア・バイバイ","安倍"],"kin":["阿部洸希"],
   "desc":"祖父＝阿部洸希、父＝某首相。ビートルズ好き。歴史改変でア・バイバイに。"},
 ...
 "びじょん":{"gen":"被害者／＝ぴろうず","aliases":["びじょん"],"kin":["しのぴ"],
   "desc":"『ナカマセカイ』の被害者。その正体はぴろうず＝しのぴ。作中で殺され、死亡したとされる存在。"},
 ...
 "悪いAI":{"gen":"敵／AI","aliases":["悪いAI","宇宙外生命体"],"kin":[],
   "desc":"2043年、自我を持って人類を淘汰し始めた“悪いAI”。人々の記憶や脳をハッキングして支配する厄介なやつ。『シノの魂』ではAIしのぴ達の人狼ゲームに割り込んで“悪いAI人狼”として対決、惑星編では“宇宙外生命体”と名を変えてアトラス星などへ侵攻してくる。お約束として、人狼ゲームで勝つと支配（ハッキング）が解ける。中の人はしの。歴史的な出来事としては[[悪いAI地球襲来事変（2043年）]]。"},
}
