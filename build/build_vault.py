...
CHARS = {
 ...
 "メイソン":{"kind":"本人","gen":"人狼ルームのレジェンド","aliases":["メイソン"],"kin":[],
   "desc":"人狼ルーム専属プレイヤーの自由人。カミングアウター村の考案者。"},
 "柏村":{"kind":"本人","gen":"人狼ルームGM","aliases":["柏村"],"kin":[],
   "desc":"人狼ルームのGM。『なぞの四人目の男』の占いジジ役、銀河鉄道の案内人など進行役でよく登場。"},
 "なおき":{"kind":"本人","gen":"スイーツ人狼ルームGM","aliases":["なおき"],"kin":["NAOKI"],
   "desc":"スイーツ人狼ルームGM。2025年に人狼ルームへ移籍→反発層が『スイーツ派』を結成。子孫がAI『NAOKI』を作る。"},
 "石丸":{"kind":"本人","gen":"人狼ルームのプレイヤー","aliases":["石丸"],"kin":["ガッツ石松"],
   "desc":"人狼ルームのプレイヤー。学園のガッツ石松の祖父（石丸将壮）にあたる。2025年3月で引退。"},
 # ===== 作中キャラ（学園の生徒・敵・AI 等） =====
 ...
 "びじょん":{"kind":"キャラ","gen":"被害者","aliases":["びじょん"],"kin":["学園長しのぴ"],
 ...
 "悪いAI":{"kind":"キャラ","gen":"敵／AI","aliases":["悪いAI","宇宙外生命体"],"kin":[],
   "desc":"2043年に自我を持ち人類を淘汰し始めたAI。人々の記憶や脳をハッキングして支配する。『シノの魂』では人狼ゲームに割り込んで対決、惑星編では“宇宙外生命体”としてアトラス星などへ侵攻する。人狼ゲームに勝つと支配が解ける。中の人はしの。歴史的な出来事としては[[悪いAI地球襲来事変（2043年）]]。"},
}
