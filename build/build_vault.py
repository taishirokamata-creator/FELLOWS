...
CHARS = {
 "しのぴ":{"gen":"創始者／GM","aliases":["しの","しのぴ","学園長","AIしのぴ","ぴろうず","りょー"],
   "kin":["にゃんぽ子","ギャラガー"],
   "desc":"FELLOWS貸切主催・GM。青森出身。人間しのぴは2034年に病死し、以後 AIしのぴ→（超未来では）ぴろうず として物語全体を貫く“世界そのもの”。"},
 ...
 "三田村以外の新入生ほか":{"gen":"子世代・新入生","aliases":["ストーブ","たくや","きゅうまる","まぐろ","ルイ","幸子","いと","夏子","すー夫","グッチ","ガッツ石松","はちお","はちまる"],"kin":[],
   "desc":"ヘンリー王子・ストーブ・たくや・まぐろ・％・G・ルイ1444世・幸子・いと・夏子・すー夫・グッチ裕三・ガッツ石松・はちお 等、個性豊かなフェローズ学園の生徒たち。"},
...
# ---------- 設定（世界観）: マッチトークン ----------
WORLD_MATCH = {
 "人狼ルーム":["人狼ルーム"], "FELLOWS貸切":["FELLOWS貸切","貸切"], "フェローズ学園":["FELLOWS学園","学園"],
...
各シナリオ冒頭で繰り返される“フェローズ学園世界の正史”。正典『FELLOWS学園_世界観・事前共有.pdf』では作中の「現在」は **2076年**（初期台本の2073〜2075表記から更新）。
...
tags: [HOME, FELLOWS]
---
# 🐺 FELLOWS貸切 / フェローズ学園 — 資料金庫

人狼ルーム『FELLOWS貸切』のストーリー人狼と、近未来SF『フェローズ学園』の設定データベース。
